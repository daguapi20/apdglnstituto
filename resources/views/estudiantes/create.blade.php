              ...
              <div class="col-md-12">
                <div class="card card c-callout c-callout-primary shadow-lg">
                    <div class="card-header">
                        <h4><i class="fas fa-user mr-4"></i> Registrar Estudiante</h4>
                    </div>
                  <div class="card-body">
                      <div class="row">
                                    ...
                                    <div class="row ">
                                                ...
                                                <select name="tipodocumento_id"  class="form-control @error('tipodocumento_id') is-invalid @enderror ">
                                                    ...
                                                    @foreach ($tipodocumentos as $tipodocumento)
                                                        <option  value="{{$tipodocumento->id}}" 
                                                            {{old('tipodocumento_id')==$tipodocumento->id ? 'selected' : '' }}
                                        ...
                                        <div class="form-group  col-sm-2 ">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                name="dni" value="{{old('dni')}}" placeholder="Número cédula" >
                                        ...
                                        <div class="form-group  col-sm-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                name="nacionalidad" value="{{old('nacionalidad')}}" placeholder="Nacionalidad" >
                                                ...
                                                <select name="ocupacione_id"  class="form-control @error('ocupacione_id') is-invalid @enderror  ">
                                                    ...
                                                    @foreach ($ocupaciones as $ocupacione)
                                                        <option  value="{{$ocupacione->id}}"
                                                            {{old('ocupacione_id')==$ocupacione->id ? 'selected' : '' }}
                                        ...
                                        <div class="form-group  col-sm-2">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" class="form-check-input"  name="discapacidad" id="discapacidad_0" value="0" checked  onchange="cambiadiscapacidad();"> 
                                                    <label class="form-check-label" >No</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" class="form-check-input" name="discapacidad" id="discapacidad_1" value="1" onchange="cambiadiscapacidad();"> 
                                        ...
                                        <div id="tipo_discapacidad" class="form-group  col-sm-2" style="display: none">
                                        ...
                                        <div id="porcentaje" class="form-group  col-sm-2" style="display: none">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                name="porcentaje" value="{{old('porcentaje')}}" placeholder="Porcentaje" >
                                        ...
                                        <div class="form-group  col-sm-2">
                                            ...
                                            <div class="col-md-12">
                                                <select name="direccion_cantone_id" id="direccion_cantone_id"  class="form-control @error('direccion_cantone_id') is-invalid @enderror  ">
                                                    ...
                                                    @foreach ($cantones as $cantone)
                                                        <option  value="{{$cantone->id}}" 
                                                            {{old('direccion_cantone_id')==$cantone->id ? 'selected' : '' }}
                                                            >{{$cantone->canton}}</option>  
                                                    @endforeach
                                                </select> 
                                        ...
                                        <div class="form-group  col-sm-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                name="telefono_fijo" value="{{old('telefono_fijo')}}" placeholder="Convencional" >
                                        ...
                                        <div class="form-group  col-sm-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                name="telefono_movil" value="{{old('telefono_movil')}}" placeholder="Celular" >
                                        ...
                                        <div class="form-group  col-sm-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                name="telefono_parentesco" value="{{old('telefono_parentesco')}}" placeholder="Teléfono pariente cercano" >
                                        ...
                                        <div class="form-group  col-sm-4">
                                            ...
                                            <div class="col-md-12">
                                                <select name="padre_ocupacione_id"  class="form-control @error('padre_ocupacione_id') is-invalid @enderror ">
                                                    ...
                                                    @foreach ($ocupaciones as $ocupacione)
                                                        <option  value="{{$ocupacione->id}}" 
                                                            {{old('padre_ocupacione_id')==$ocupacione->id ? 'selected' : '' }}
                                                            >{{$ocupacione->ocupacion}}</option>  
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group  col-sm-4">
                                            ...
                                            <div class="col-md-12">
                                                <select name="madre_ocupacione_id"  class="form-control @error('madre_ocupacione_id') is-invalid @enderror">
                                                    ...
                                                    @foreach ($ocupaciones as $ocupacione)
                                                        <option  value="{{$ocupacione->id}}" 
                                                            {{old('madre_ocupacione_id')==$ocupacione->id ? 'selected' : '' }}
                                                            >{{$ocupacione->ocupacion}}</option>  
                                                    @endforeach
                                                </select> 
...
<script>
  ...
  function cambia_cantones1(select){ 
      ...
      if (provincia != 0) { 
          ...
          direccion_cantone_id.options[0].value = "Asignar un cantón" 
          direccion_cantone_id.options[0].text = "Asignar un cantón" 
      } 
      direccion_cantone_id.options[0].selected = true 
  };

  //discapacidades
  function cambiadiscapacidad(){
    discapacidad_0 = document.getElementById('discapacidad_0').checked; 
    discapacidad_1 = document.getElementById('discapacidad_1').checked;
       
    if (discapacidad_1) { //Si
