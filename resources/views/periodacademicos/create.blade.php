        ...
        <div class="row">
              ...
              <div class="col-sm-6">
                <div class="card card-accent-primary shadow-lg">
                  ...
                  <div class="card-body">
                      <div class="row">
                          <form method="POST"  action="{{ route('periodacademicos.store')}} ">
                              @csrf 
                                ...
                                <div class="form-group row col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <input type="date" class="form-control @error('fecha_inicio') is-invalid @enderror"  
                                         name="fecha_inicio" value="{{old('fecha_inicio')}}" placeholder="Fecha de Inicio" >
                                ...
                                <div class="form-group row col-md-6">
                                    ...
                                    <div class="col-md-12 ">
                                        <input type="date" class="form-control @error('fecha_final') is-invalid @enderror"  
                                         name="fecha_final" value="{{old('fecha_final')}}" placeholder="Fecha  Final" >
                                    ...
                                    <div class="col-md-12 ">
                                        <select  name="especialidades[]"  class="form-control @error('especialidades') is-invalid @enderror  " multiple >
                                            @foreach ($especialidades as $especialidade)
                                                <option {{ collect(old('especialidades'))->contains($especialidade->id) ? 'selected' :  ''}}
