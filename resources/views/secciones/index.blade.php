            ...
            <div class="col-md-12">
                <div class="card card-accent-primary shadow-lg">
                    <div class="card-header bg-primary  d-flex justify-content-between aling-items-end ">
                        ...
                        <a class=" btn btn-primary " href="{{route('secciones.create')}}"> <i class=" font-weight-bold cil-plus mr-1"></i>Agregar</a> 
                    </div>
                    <div class="card-table  table-responsive">
                        <table class="table table-hover  table-bordered align-middle">
                            ...
                            @foreach ($secciones as $seccione)
                                <tr>
                                <td class="text-center" >{{$seccione->id}} </td>
                                <td >{{$seccione->nombre}} </td>
                                <td>
                                    <div class=" form-inline justify-content-center px-4 ">
                                        <a class=" btn btn-sm   btn-info mr-3 mt-2 cil-pencil" href="{{route('secciones.edit', $seccione)}}"></a>
