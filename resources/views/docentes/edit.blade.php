              ...
              <div class="col-sm-12">
                <div class="card card c-callout c-callout-primary shadow-lg">
                    <div class="card-header">
                        <h4><i class="fas fa-user-plus mr-4"></i>Editar profesor</h4>
                    </div>
                  <div class="card-body">
                      <div class="row">
                          ...
                          <div class="container col-md-12">
                              <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    <label for="dni" class="col-md-12 mt-2 col-form-label font-weight-bold ">Nro cédula 
                                        <span class="text-primary">*</span></label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control @error('dni') is-invalid @enderror"  
                                         name="dni" value="{{old('dni', $docente->dni)}}" placeholder="Número de cédula" >
                                ...
                                <div class="form-group col-sm-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        name="telefono_movil" value="{{old('telefono_movil', $docente->telefono_movil)}}" placeholder="Calles">
                                        ...
                                        <select name="cantone_id" id="cantone_id"  class="form-control @error('cantone_id') is-invalid @enderror">
                                            ...
                                            @foreach ($cantones as $cantone)
                                                <option value="{{$cantone->id}}"
                                                 {{old('cantone_id', $docente->cantone_id) == $cantone->id ? 'selected' : ''}}  
                                ...
                                <div class="form-group col-sm-3">
                                    <label for="estadocente_id" class="col-md-12 mt-2 col-form-label font-weight-bold ">Estado
                                        <span class="text-primary">*</span></label>
                                    <div class="col-md-12">
                                        <select name="estadocente_id"  class="form-control @error('estadocente_id') is-invalid @enderror">
                                            ...
                                            @foreach ($estadocentes as $estadocente)
                                                <option  value="{{$estadocente->id}} "
                                                    {{old('estadocente_id', $docente->estadocente_id)==$estadocente->id ? 'selected' : '' }}
                                ...
                                <div class="form-group col-sm-3">
                                    ...
                                    <div class="col-md-12">
                                        <select name="tipocontrato_id"  class="form-control @error('tipocontrato_id') is-invalid @enderror">
                                            <option class="form-control" value="">Asignar tipo de contrato</option>
