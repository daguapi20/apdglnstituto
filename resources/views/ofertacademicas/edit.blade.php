        ...
        <div class="row  justify-content-center ">
            <div class="col-lg-7">
                <div class="card c-callout c-callout-primary  shadow-lg">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" method="POST"  action="{{ route('ofertacademicas.update', $ofertacademica)}} ">
                            @csrf @method('PUT')
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"  class="form-control @error('nombre') is-invalid @enderror"
                                        name="nombre" value="{{old('nombre', $ofertacademica->nombre)}}" placeholder="Nombre">  
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('duracion') is-invalid @enderror" 
                                        name="duracion" value="{{old('duracion', $ofertacademica->duracion)}}" placeholder="2 periodos">
